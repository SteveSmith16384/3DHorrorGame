...
import com.scs.horrorgame.models.Skull2Model;

public class Skull2 extends AbstractEntity {
	
	private Spatial floor_geo;
	private RigidBodyControl floor_phy;
	
	public Skull2(HorrorGame _game, float x, float z) {
		super(_game, "Skull2");
		
		floor_geo = new Skull2Model(game.getAssetManager());
